package com.shinoow.acblocks.common.network;
...
public class PacketDispatcher
{
	 ...
	 */
	private static final SimpleNetworkWrapper dispatcher = NetworkRegistry.INSTANCE.newSimpleChannel(AbyssalBlocks.modid);
	...
	public static final void registerPackets() {
		...
		registerMessage(MessageBlockTrigger.class);
	}
